CUDA_VISIBLE_DEVICES=0 python -m torch.distributed.launch --nproc_per_node=1 trans.py \
        ...
        --max_length 64 \
        --train_file ../data/clueweb3/use/list2.json\
        --valid_file ../data/clueweb3/use/eval.json \
        --output_dir output/listwise-demo \
...
:<<!
CUDA_VISIBLE_DEVICES=1 python -m torch.distributed.launch --nproc_per_node=1 trans.py \
        --task mgcc55 \
        --model_name /data/users/tangyubao/translation/data/t5 \
        --run_name trans-test-lab \
        --max_length 64 \
        --mgcc_train_file_root ../data/wikibig/graded/demo55\
...
CUDA_VISIBLE_DEVICES=1 python -m torch.distributed.launch --nproc_per_node=1 trans.py \
        ...
        --run_name trans-test-lab \
        --max_length 128 \
        --max_indexing_length 256 \
        --mgcc_train_file_root ../data/wikibig/graded/wikibig_data\
        --valid_file /data/users/tangyubao/translation/filter-msdoc/trans-alldev/dev20.json \
        --output_dir output/discrimination-indexing \
        --learning_rate 0.0005 \
        --warmup_steps 10000 \
